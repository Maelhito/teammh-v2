...
const PUBLIC_PATHS = ["/login", "/auth/confirm", "/auth/set-password", "/acces-suspendu", "/inscription", "/ttl/bienvenue"];
...
export async function middleware(request: NextRequest) {
  ...
  const PROTECTED = ["/dashboard", "/admin", "/profil", "/modules", "/calendrier", "/mesures", "/entrainement", "/coach", "/ttl"];
  ...
  const NEEDS_ROLE = ["/dashboard", "/admin", "/coach", "/profil", "/modules", "/calendrier", "/mesures", "/entrainement", "/ttl"];
  let role = "cliente";
