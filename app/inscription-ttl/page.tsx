      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div>
            ...
            <PasswordInput style={inputStyle} value={password} onChange={setPassword} placeholder="8 caractères minimum" required autoComplete="new-password" toggleColor={ttlColors.muted} />
          </div>

          <div>
            <label style={labelStyle}>CONFIRMER LE MOT DE PASSE</label>
            <PasswordInput style={inputStyle} value={confirm} onChange={setConfirm} placeholder="••••••••" required autoComplete="new-password" toggleColor={ttlColors.muted} />
          </div>
