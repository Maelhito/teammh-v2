  ...
  return (
    <div style={{ background: ttsColors.card, border: `1px solid ${ttsColors.cardBorder}`, borderRadius: 16, padding: "14px 18px", marginTop: 12 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <p className="font-body" style={{ margin: 0, color: ttsColors.muted, fontSize: 12 }}>
        ...
        {validated ? (
          <button
            ...
            className="font-body"
            style={{ background: "transparent", border: "none", color: ttsColors.muted, fontSize: 11, fontWeight: 700, cursor: "pointer", textDecoration: "underline", padding: 0 }}
          >
            Modifier
          </button>
        ) : (
          ...
          return (
            <button
              ...
              style={{
                ...
                aspectRatio: "1",
                borderRadius: 10,
                border: `1px solid ${active ? ttsColors.redBright : ttsColors.cardBorder}`,
                background: active ? (validated ? "rgba(255,255,255,0.06)" : ttsColors.red) : "transparent",
                color: validated && active ? ttsColors.muted : "#fff",
