...
import { getProgrammes, computeCurrentNumeroMois, computeCurrentSemaine, getRecettes, getCapsules, getSeancesProgress } from "@/lib/ttl";
import TtlHeader from "@/components/TtlHeader";
import TtlBottomNav from "@/components/TtlBottomNav";
import PreviewBanner from "@/components/PreviewBanner";
import TtlBibliotheque from "./TtlBibliotheque";
...
export default async function TtlBibliothequePage({ searchParams }: PageProps) {
  ...
  return (
    <div style={{ backgroundColor: "#0D0D0D", minHeight: "100vh", paddingBottom: 100 }}>
      ...
      <div className="mx-auto" style={{ maxWidth: 480 }}>
        <TtlHeader variant="page" title="Bibliothèque" subtitle="Séances · Recettes · Capsules" />
