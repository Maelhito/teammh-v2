...
import { inputStyle, cardStyle, PageHeader } from "../TtlShared";
...
export default function ClientesOffres() {
  ...
  return (
    <div>
      <PageHeader title="Clientes Time To Last" subtitle="Affecter ou changer l'offre d'une cliente" />
      ...
      {confirmStep === 1 && pendingChange && (
        <Modal onClose={() => { setConfirmStep(0); setPendingChange(null); }}>
          ...
          <p style={{ color: "var(--admin-text-muted)", fontSize: 13, lineHeight: 1.5 }}>
            Le parcours normal est <strong>TTM → TTL</strong>. Le passage de{" "}
