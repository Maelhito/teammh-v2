...
import FinDeSeance from "@/components/FinDeSeance";
...
export default function SeanceViewer({
  ...
  if (done) {
    ...
    // L'écran de fin est le même pour une séance construite et pour une vidéo :
    // il vit dans components/FinDeSeance.
    return (
      <FinDeSeance
        titre={seanceName || seanceData.nom}
