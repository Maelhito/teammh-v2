...
export function computeTtsBadges({ hasWatchedAny, onboardingDone, seancesValidees, streakCurrent, joursDepuisDebut }: ComputeBadgesParams): TtsBadge[] {
  return [
...
export function nextBadgeToUnlock(badges: TtsBadge[]): TtsBadge | null {
