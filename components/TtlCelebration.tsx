...
export default function TtlCelebration({ message, emoji = "🎉", onDone }: Props) {
  useEffect(() => {
    ...
    <div style={{ position: "fixed", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 400, pointerEvents: "none" }}>
      ...
      <div
        style={{
          ...
          border: `2px solid ${ttlColors.green}`,
          borderRadius: 20,
          padding: "24px 32px",
          textAlign: "center",
          boxShadow: "0 10px 40px rgba(0,0,0,0.5)",
          animation: "ttl-celebration-pop 1.6s ease forwards",
        }}
      >
