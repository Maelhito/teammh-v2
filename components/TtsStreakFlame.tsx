...
export default function TtsStreakFlame({ days }: { days: number }) {
  ...
  return (
    <>
      ...
      <svg width={size} height={size * 1.3} viewBox="0 0 24 32" style={{ flexShrink: 0, overflow: "visible" }}>
        <defs>
          <linearGradient id="tts-flame-outer-grad" x1="0" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="#8B0000" />
            <stop offset="55%" stopColor="#E63946" />
            <stop offset="100%" stopColor="#FFA733" />
          </linearGradient>
          <linearGradient id="tts-flame-inner-grad" x1="0" y1="1" x2="0" y2="0">
        ...
        <path
          ...
          fill="url(#tts-flame-outer-grad)"
          style={{
            transformBox: "fill-box",
            transformOrigin: "50% 100%",
            animation: `tts-flame-outer ${speed * 1.4}s ease-in-out infinite`,
          }}
        />
        <path
          d="M12 11 C 10 14 8 17 8 20.5 C 8 24 10 27 12 29 C 14 27 16 24 16 20.5 C 16 17 14 14 12 11 Z"
          fill="url(#tts-flame-inner-grad)"
          style={{
            transformBox: "fill-box",
            transformOrigin: "50% 100%",
            animation: `tts-flame-inner ${speed}s ease-in-out infinite`,
          }}
        />
      </svg>
    </>
