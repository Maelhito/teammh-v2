...
import TtsStreakFlame from "./TtsStreakFlame";
...
type TtsHeaderProps = HomeProps | PageProps;
  ...
  return (
    <div style={{ background: ttsHeaderGradient, padding: "18px 22px 26px", borderBottomLeftRadius: 32, borderBottomRightRadius: 32 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {props.variant === "page" && (
          <Link href="/tts/profil" style={{ color: "#fff", fontSize: 20, textDecoration: "none" }} aria-label="Profil">
            ⚙️
          </Link>
        )}
      </div>
      ...
      {props.variant === "home" ? (
        <>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <p className="font-body" style={{ color: ttsColors.offWhite, fontSize: 13, opacity: 0.85, marginTop: 14, margin: "14px 0 0" }}>
            ...
            {!!props.streak && (
              ...
              >
                <TtsStreakFlame days={props.streak} />
        ...
        <>
          ...
          {props.subtitle && (
            <p className="font-body" style={{ color: ttsColors.muted, fontSize: 12, marginTop: 4 }}>{props.subtitle}</p>
          )}
        </>
      )}
    </div>
